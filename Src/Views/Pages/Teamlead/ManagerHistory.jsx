import { View, Text, StyleSheet, FlatList,Modal,
            ...
            >
              <TouchableOpacity style={styles.modalOverlay} activeOpacity={1}>
                <View style={styles.modalContainer}>
                  ...
                  <TouchableOpacity style={styles.filterOption}  onPress={() => handleFilterHistory("all")} >
